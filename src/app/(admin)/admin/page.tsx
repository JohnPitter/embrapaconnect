      ...
      <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <Card className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-light-muted/60">
            ...
            <span className="text-[12px] uppercase tracking-wider">Fazendas</span>
          </div>
          <StatBlock value={String(totalFarms)} label="Total mapeadas" accent />
        </Card>
        <Card className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-light-muted/60">
            <Users className="h-4 w-4" />
            <span className="text-[12px] uppercase tracking-wider">Produtores</span>
          </div>
          <StatBlock value={String(totalFarmers)} label="Cadastrados" accent />
        </Card>
        <Card className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-light-muted/60">
            <Sprout className="h-4 w-4" />
            <span className="text-[12px] uppercase tracking-wider">Plantações</span>
          </div>
          <StatBlock value={String(totalCrops)} label="Ativas" />
        </Card>
        <Card className="flex flex-col gap-2">
          <div className="flex items-center gap-2 text-light-muted/60">
            <AlertTriangle className="h-4 w-4" />
            <span className="text-[12px] uppercase tracking-wider">Alertas</span>
          </div>
          <StatBlock value={String(totalAlerts)} label="Registrados" />
        </Card>
      </div>
