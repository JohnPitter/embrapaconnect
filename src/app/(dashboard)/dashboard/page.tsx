...
import { Tractor, Sprout, Plus, AreaChart } from "lucide-react";
    ...
    <>
      ...
      <div className="flex flex-col gap-8 p-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <AnimateIn threshold={0} delay={80}>
            <CardLight>
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-lime-accent/10 p-2.5">
          ...
          <AnimateIn threshold={0} delay={160}>
            <CardLight>
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-lime-accent/10 p-2.5">
                  <AreaChart className="h-5 w-5 text-mid-green" />
                </div>
                <div>
                  <p className="text-[12px] font-medium uppercase tracking-wider text-gray-400">
                    Área total
        ...
        {/* Fazendas recentes */}
        <AnimateIn threshold={0} delay={260}>
          <div>
